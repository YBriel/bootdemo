...
public class TestJedis {
    ...
    public void initJedis(){
        jedis=new Jedis("39.106.121.52",6379);
        jedis.auth("mz666");
    }
    ...
    @Test
    public void testKey(){
        System.out.println(jedis.keys("*")); //所有的
        System.out.println(jedis.exists("k1")); //是否存在K1
        jedis.expire("k1", 60); //设置过期时间
        System.out.println(jedis.ttl("k1")); //查看过期时间
        System.out.println(jedis.type("k1")); //类型

        System.out.println(jedis.incr("count")); //自增
